...
public class FolderDetailFragment extends BaseMusicListFragment {
    private static final String KEY_ALBUM = "ALBUM";

    private Disposable mCheckFavoriteDisposable;

    public static FolderDetailFragment newInstance(String album) {
    ...
    protected BaseMusicListViewModel onCreateMusicListViewModel(ViewModelProvider viewModelProvider) {
        FolderDetailViewModel viewModel = viewModelProvider.get(FolderDetailViewModel.class);
