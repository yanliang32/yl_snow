...
public class FolderDetailViewModel extends BaseMusicListViewModel {
    @NonNull
    @Override
    protected List<Music> loadMusicListItems() {
        List<Music> musicList = MusicStore.getInstance().getFolderAllMusic(getAlbumName());
    ...
    private String getAlbumName() {
        ...
        return album.substring(FolderDetailActivity.ALBUM_PREFIX.length());
    }
}
